...
const cmd = `ffmpeg -y -i "usecase-mom.mp4" ${inputs} -filter_complex "${chain}" -map "[vout]" -c:v libx264 -crf 18 -preset slow -movflags +faststart "/tmp/mom_captioned.mp4"`;
